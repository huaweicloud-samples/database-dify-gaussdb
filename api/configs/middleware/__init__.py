...
from .vdb.gaussdb_config import GaussDBConfig
...
class DatabaseConfig(BaseSettings):
    ...
    DB_TYPE: Literal["postgresql", "mysql", "oceanbase", "seekdb", "gaussdb"] = Field(
        description="Database type to use. OceanBase is MySQL-compatible. GaussDB uses the opengauss-sqlalchemy dialect.",
        default="postgresql",
    )
    ...
    def SQLALCHEMY_ENGINE_OPTIONS(self) -> SQLAlchemyEngineOptionsDict:
        ...
        if self.SQLALCHEMY_DATABASE_URI_SCHEME.startswith(("postgresql", "opengauss")):
